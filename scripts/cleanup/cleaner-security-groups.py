...
"""
Deletion Criteria : Delete security_group associated with the ocp4-upi-compute-ibmcloud-powervs, and remove the security_group with the postfix `*-workers-sg`
...
try:
    ...
    for sg in sgs:
      ...
      #print(sgts)
      print("SECURITY GROUP TARGETS FOR : " , sg['name'] , " || ", vpc_name) 
